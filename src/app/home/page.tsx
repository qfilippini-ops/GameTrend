      ...
      <div className="px-4 pt-4 pb-8 space-y-5">
          ...
          <div className="relative z-10 flex items-center justify-between gap-4">
            <div>
              ...
              <h1 className="text-2xl font-display font-bold text-white leading-tight tracking-tight">
                Joue.{" "}
                <span className="text-gradient-brand">Crée.</span>{" "}
                Partage.
              </h1>
            </div>
        ...
        <div id="games">
          <h2 className="text-base font-display font-bold text-white mb-3 flex items-center gap-2">
            <span>🎮</span> Jeux disponibles
          </h2>

          {/* Grille de jeux — hauteur fixe uniforme */}
          ...
          {/* Créer + Explorer — même taille, côte à côte */}
          <div className="grid grid-cols-2 gap-3 mt-3">
            ...
            >
              ...
              <div>
                <p className="text-white font-semibold text-xs leading-tight">Créer un preset</p>
                <p className="text-surface-600 text-[10px]">Personnalise le jeu</p>
              </div>
            </Link>
            ...
            >
              ...
              <div>
                <p className="text-white font-semibold text-xs leading-tight">Explorer</p>
                <p className="text-surface-600 text-[10px]">La bibliothèque</p>
              </div>
            </Link>
          </div>
        </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-base font-display font-bold text-white flex items-center gap-2">
                <span className="text-orange-400">🔥</span> Populaires
              </h2>
              <Link
                href="/presets"
        ...
        <div>
          <h2 className="text-base font-display font-bold text-white mb-3 flex items-center gap-2">
            <span>🚀</span> Bientôt disponible
          </h2>
          <div className="grid grid-cols-2 gap-3">
            {[
              { icon: "🧩", name: "Quiz Battle", tags: "Culture · Fun" },
              { icon: "🏷️", name: "Enchères", tags: "Stratégie · Social" },
            ].map((game) => (
              <div
                key={game.name}
