...
export default function GhostWordLobby() {
  ...
  return (
    <div className="min-h-screen bg-surface-950 bg-grid">
      <Header title="GhostWord" backHref="/" />
      ...
      <div className="px-4 pt-4 pb-8 space-y-4">
        ...
        <AnimatePresence>
          {restored && (
            ...
            >
              <span>↩</span>
              <span className="flex-1 font-medium">Dernière session restaurée</span>
              <button
                onClick={() => {
                  setPlayerNames(["", "", ""]);
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="text-xs px-2.5 py-0.5 rounded-full bg-brand-500/15 text-brand-300 border border-brand-500/20 font-medium">
                  👥 {GHOSTWORD_META.minPlayers}–{GHOSTWORD_META.maxPlayers} joueurs
                </span>
        ...
        >
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-white font-semibold text-sm">Paramètres avancés</span>
              {hasCustomParams && (
              ...
              >
                <div className="px-4 pb-4 space-y-4 border-t border-surface-700/30">
                  ...
                  <div className="pt-4 space-y-3">
                    <p className="text-white font-semibold text-sm">Rôle spécial</p>
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-white font-semibold text-sm">Tours de discussion</p>
                      <p className="text-surface-500 text-xs mt-0.5">Tours avant chaque vote d'élimination</p>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 text-center">
                        ...
                        <p className="text-surface-500 text-xs mt-0.5">
                          {discussionTurns === 1 ? "tour" : "tours"} avant vote
                        </p>
                      </div>
                      <button
                        type="button"
        ...
        >
          ...
          >
            <span>🌐</span> Créer une partie en ligne
          </Link>
        </motion.div>
