...
//   - on réactive explicitement les profils publics et les OG dynamiques
//     (Discord/X/WhatsApp ont besoin de récupérer ces images)
//   - disallow couvre les pages privées sans intérêt SEO
//
// IMPORTANT : on évite les commentaires de bloc /*  */ dans ce fichier car
// les patterns robots contiennent "*/" qui ferment prématurément le bloc et
// font planter le parseur SWC. Tout est en // pour cette raison.
//
